(function($) {
  ...
  Curry.Helpers.Validator = {
     ...
     */
    watchList: ['email', 'email_from', 'email_to', 'password', 'password_confirmation', 'first_name', 'last_name', 'name', 'project_name', 'ticket_title', 'genre', 'priority', 'assignee', 'fix_version', 'description'],
